        ...
        <div className="card instructions-card">
          ...
          <div className="card-content">
            <ol className="instructions-list">
              <li>
                <strong>Click "Mount Drive"</strong> to create your {driveStatus?.driveLetter || 'Z'}: drive
              </li>
              <li>
                <strong>Open Windows Explorer</strong> - you'll see {driveStatus?.driveLetter || 'Z'}: Apex Drive
              </li>
              <li>
                <strong>Browse your files</strong> - only files you have permission to access are shown
              </li>
              <li>
                <strong>Files sync automatically</strong> - changes are securely uploaded to the server
              </li>
            </ol>
            <div className="security-info">
              <div className="security-note">
                ...
                <span>Your drive only shows files from matters you have access to.</span>
              </div>
              <div className="security-note">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
