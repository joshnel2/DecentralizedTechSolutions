...
import { 
  ...
  Settings, ExternalLink, Briefcase, FileText,
  X, Sparkles, Wand2, FolderSync,
...
export default function SecureAdminDashboard() {
  ...
  const [includeTasks, setIncludeTasks] = useState(() => sessionStorage.getItem('clio_includeTasks') !== 'false')
  const [includeNotes, setIncludeNotes] = useState(() => sessionStorage.getItem('clio_includeNotes') !== 'false')
  ...
  useEffect(() => { sessionStorage.setItem('clio_includeTasks', String(includeTasks)) }, [includeTasks])
  useEffect(() => { sessionStorage.setItem('clio_includeNotes', String(includeNotes)) }, [includeNotes])
  ...
  const autoStartClioImport = async (connectionId: string, firmName: string) => {
    ...
    const storedIncludeTasks = sessionStorage.getItem('clio_includeTasks') !== 'false'
    const storedIncludeNotes = sessionStorage.getItem('clio_includeNotes') !== 'false'
    ...
    console.log('[CLIO] Import options from sessionStorage:', {
      ...
      includeTasks: storedIncludeTasks,
      includeNotes: storedIncludeNotes,
                                ...
                                <div style={{ marginTop: '1rem', padding: '0.75rem', background: 'rgba(59, 130, 246, 0.1)', borderRadius: '8px' }}>
                                  ...
                                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
                                    ...
                                    <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                                      ...
                                      <span style={{ fontSize: '0.85rem' }}>Tasks</span>
                                    </label>
                                    <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                                      <input type="checkbox" checked={includeNotes} onChange={(e) => setIncludeNotes(e.target.checked)} />
                                      <span style={{ fontSize: '0.85rem' }}>Notes</span>
                                    </label>
                            ...
                            <>
                              ...
                              <div className={styles.migrationSection}>
                                ...
                                <p className={styles.sectionDescription}>
                                  This will pull all data from Clio: Users, Contacts, Matters, Time Entries, Bills, Calendar Events, Tasks, Notes, and Documents.
