...
import { Calculator, RefreshCw, Search, ArrowLeft, DollarSign, TrendingUp, FileText } from 'lucide-react'
...
export function QuickBooksIntegrationPage() {
  ...
  const [_activeTab, setActiveTab] = useState<'invoices' | 'customers'>('invoices')
