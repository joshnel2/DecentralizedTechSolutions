...
export function TimeTrackingPage() {
  ...
  const _getClientForMatter = (matterId: string | null | undefined) => {
...
function NewTimeEntryModal({ onClose, onSave, matters, userId: _userId }: { onClose: () => void; onSave: (data: any) => Promise<void>; matters: any[]; userId: string }) {
