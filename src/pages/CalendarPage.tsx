...
import { 
  ...
  Clock, MapPin, Users, Edit2, Trash2, Video, UserPlus, Check
} from 'lucide-react'
import { 
...
export function CalendarPage() {
  const { events, matters, clients: _clients, addEvent, updateEvent, deleteEvent, fetchEvents, fetchMatters } = useDataStore()
