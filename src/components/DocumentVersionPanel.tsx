...
import { wordOnlineApi, driveApi } from '../services/api'
...
export function DocumentVersionPanel({ 
  ...
  const [_syncEnabled, _setSyncEnabled] = useState(true) // Always enabled by default
  const { 
    isSyncing, 
    lastSyncAt, 
    lastSyncVersion,
    ...
    onVersionCreated: (_versionNumber) => {
