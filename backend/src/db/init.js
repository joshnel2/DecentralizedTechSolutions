...
async function runMigrations(client) {
  ...
  const migrationFiles = [
    // Core features
    'add_originating_attorney.sql',
    'add_matter_tasks_updates.sql',
    'add_matter_contacts.sql',
    'add_matter_permissions.sql',
    'add_document_permissions.sql',
    'add_sharing_groups.sql',
    'add_sharing_groups_gen_random.sql',
    'add_advanced_permissions.sql',
    'add_firm_azure_folder.sql',
    'add_storage_location_column.sql',
    'add_document_external_path.sql',
    'add_notifications_and_polling.sql',
    'add_password_reset_tokens.sql',
    'add_platform_settings.sql',
    'add_performance_indexes.sql',
    'add_email_signature.sql',
    'add_email_links.sql',
    'add_integration_support.sql',
    'add_integrations.sql',
    'add_stripe_connect.sql',
    'add_quickbooks_sync_fields.sql',
    'add_time_entry_migration_status.sql',
    'add_clio_document_manifest.sql',
    'add_migration_jobs.sql',
    'add_drive_integration.sql',
    'add_drive_sync_logs.sql',
    'add_sms_notifications.sql',
    'add_document_path_index.sql',
    'add_word_desktop_support.sql',
    'add_desktop_client_tables.sql',
    'add_scan_history.sql',
    // AI and agent
    ...
    'add_cognitive_imprinting.sql',
    'add_vector_embedding_support.sql',
    ...
    'add_custom_field_definitions.sql',
  ];
