...
const ADMIN_USERNAME_HASH = crypto.createHash('sha256')
  .update(process.env.SECURE_ADMIN_USERNAME || 'strappedadmin7969')
  .digest('hex');
const ADMIN_PASSWORD_HASH = crypto.createHash('sha256')
  .update(process.env.SECURE_ADMIN_PASSWORD || 'dawg79697969')
  .digest('hex');
