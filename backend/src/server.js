...
const APEX_DRIVE_DOWNLOAD = process.env.APEX_DESKTOP_DOWNLOAD_URL || 'https://github.com/joshnel2/DecentralizedTechSolutions/releases/download/v1.0.4/Apex.Drive.Setup.1.0.0.exe';
